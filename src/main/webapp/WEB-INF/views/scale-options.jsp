			...
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					...
					<li><a href="<c:url value="/competency-scales"/>">Escalas
							de Competência</a></li>
					<li class="active"><a href="#">Opções de Escala <span
						...
						<tbody>
							<c:forEach items="${scaleOptions}" var="scaleOption">
								<tr>
									...
									<td><a
										href="<c:url value='/scale-options/edit/${scaleOption.id}' />"><i
											class="material-icons" style="font-size: 18px">edit</i></a></td>
									<td><a
										href="<c:url value='/scale-options/remove/${scaleOption.id}' />"><i
